      ...
      <div>
        ...
        <div className="relative">
          ...
          <input
            ...
            required
            className="w-full pl-12 pr-12 py-3 bg-[#141414] border border-white/10 rounded-lg focus:border-[#D604E0] focus:ring-1 focus:ring-[#D604E0] outline-none transition-colors text-white"
            placeholder="••••••••"
          />
          <button
            type="button"
